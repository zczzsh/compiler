...
public class Main {
    ...
    private static void testSymInfo() {
        ...
        // string
        Type[] typeList = {new BoolType(), new IntType()};
    ...
    private static void testExceptions() {
        ...
        try {
            ...
            symTab.removeScope();
            try {
                symTab.addDecl("name", new SymInfo(new IntType()));
        ...
        symTab = new SymTable();
        try {
            symTab.addDecl(null, new SymInfo(new IntType()));
            error("SymTable.addDecl", 
    ...
    private static void testAddDecl() {
        ...
        SymInfo sym1 = new SymInfo(new BoolType()), sym2 = new SymInfo(new IntType());
    ...
    private static void testLookup() {
        SymInfo sym, oneSym = new SymInfo(new IntType());
        ...
        try { 
            ...
            symTab.addScope();
            SymInfo localSym = new SymInfo(new IntType());
    ...
    private static void testPrint() {
        ...
        try {
            symTab.print();
            try {
                symTab.addDecl("aaa", new SymInfo(new BoolType()));
                symTab.addDecl("bbb", new SymInfo(new IntType()));
                symTab.addScope();
                symTab.addDecl("ccc", new SymInfo(new VoidType()));
                symTab.addScope();
                symTab.addDecl("ddd", new SymInfo(new IntType()));
            } catch (Exception e) {
                error("SymTable.addDecl", 
